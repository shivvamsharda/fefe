...
BEGIN
    LOOP
        ...
        -- Check if this room name already exists - fix ambiguous column reference
        IF NOT EXISTS (SELECT 1 FROM public.spaces_v2 WHERE spaces_v2.room_name = room_name) THEN
            RETURN room_name;
        END IF;
